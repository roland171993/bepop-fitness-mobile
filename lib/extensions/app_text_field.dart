        ...
        return (s) {
          ...
          if (!s.trim().validateEmail())
            return widget.errorInvalidEmail
                .validate(value: languages.lblEmailIsInvalid);
          return null;
        };
        ...
        return (s) {
          ...
          if (s.trim().length < passwordLengthGlobal)
            return widget.errorMinimumPasswordLength.validate(
                value: languages.lblMinimumPasswordLengthShouldBe +
                    ' ' +
        ...
        return (s) {
          if (s!.trim().isEmpty)
            return widget.errorThisFieldRequired
                .validate(value: errorThisFieldRequired);
          if (!s.validateURL()) {
            return widget.errorInvalidURL
                .validate(value: languages.lblInvalidUrl);
          }
          return null;
        };
        ...
        return (s) {
          ...
          if (s.contains(' ')) {
            return widget.errorInvalidUsername
                .validate(value: languages.lblUsernameShouldNotContainSpace);
          }
          return null;
        };
