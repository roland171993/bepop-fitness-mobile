...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.braintree.payment.BraintreePaymentPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin flutter_braintree_payment, com.braintree.payment.BraintreePaymentPlugin", e);
    }
    try {
    ...
    try {
      flutterEngine.getPlugins().add(new com.myfatoorahflutter.my_fatoorah_flutter.MyfatoorahFlutterPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin my_fatoorah_payment_flutter, com.myfatoorahflutter.my_fatoorah_flutter.MyfatoorahFlutterPlugin", e);
    }
    try {
